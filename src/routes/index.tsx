...
import ChatSessionPage from '@/pages/chat';
import ChatRoomPage from '@/pages/chat/chat-room/ChatRoom';
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            path: '', 
            element: <WrapperRouteComponent element={<ChatSessionPage />} titleId="title.chatList" />,
          },
          {
            path: ':sessionCode', 
            element: <WrapperRouteComponent element={<ChatRoomPage />} titleId="title.chatRoom" />,
          }
        ]
      },
